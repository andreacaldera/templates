...
export default () => {
  ...
  const SPEECHES = {
    ...
    'theresa-may': 'I am the face of of a strong and stable leadership. And by that I mean I\'ll need your help to lif a feather and not complain when I change my mind in 20 seconds time.',
    'leanne-wood': 'Chwyrligwgan',
    'nicola-sturgeon': 'Let me just have another wee drum and then I\'ll be ready to call another indipendence referendum',
    'caroline-lucas': 'We are all gonna die once our planet get destroyed but other than that it\'s all good and well.',
  };
